...
public class AdminApiController extends BaseController {
    ...
    @Inject
    private DepartContentsService departContentsService;
    ...
    public RestResponse newArticle(@BodyParam Contents contents) {
        ...
        siteService.cleanCache(Types.SYS_STATISTICS);
        //增加周报汇总
        departContentsService.add(contents);
     ...
     * @return
     */
    @GetRoute("departArticles")
    public RestResponse departArticleList(ArticleParam articleParam) {
        articleParam.setType(Types.ARTICLE);
        articleParam.setOrderBy("created desc");
        Page<DepartContents> articles = departContentsService.findDepartArticles(articleParam);
        return RestResponse.ok(articles);
    }
